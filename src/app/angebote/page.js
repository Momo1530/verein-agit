...
const translations = {
  de: {
    ...
    section3_text: "<strong>Netzwerk- und Kooperationsarbeit:</strong> Aktiver Austausch und enge Zusammenarbeit mit Systempartnern wie Schulen, der MA 11, Behörden und der Justiz.<br/><strong>Öffentlichkeitsarbeit & Konzeptentwicklung:</strong> Sensibilisierung der breiten Öffentlichkeit für Gewaltfreiheit und Zivilcourage sowie die wissenschaftlich begleitete Weiterentwicklung innovativer Interventionsmethoden.",
  ...
  tr: {
    ...
    section3_text: "<strong>Ağ ve İşbirliği Çalışması:</strong> Okullar, MA 11, resmî kurumlar ve adalet gibi sistem ortaklarıyla aktif alışveriş ve yakın işbirliği.<br/><strong>Eğitim ve İleri Eğitim:</strong> Önleme alanında kalite güvencesi için sertifikalı kursların düzenlenmesi (örn. şiddet karşıtı eğitmenlerin yetiştirilmesi).<br/><strong>Halkla İlişkiler & Konsept Geliştirme:</strong> Geniş kamuoyunun şiddetsizlik ve sivil cesaret konusunda duyarlılaştırılması ile yenilikçi müdahale yöntemlerinin bilimsel eşlikte geliştirilmesi.",
  ...
  ar: {
    ...
    section3_text: "<strong>العمل الشبكي والتعاوني:</strong> تبادل نشط وتعاون وثيق مع الشركاء في النظام مثل المدارس، وMA 11، والسلطات، والقضاء.<br/><strong>التدريب والتأهيل:</strong> إجراء دورات معتمدة (مثل تدريب مدربي مكافحة العنف) لضمان الجودة في مجال الوقاية.<br/><strong>العلاقات العامة وتطوير المفاهيم:</strong> توعية الجمهور العام باللاعنف والشجاعة المدنية، فضلاً عن التطوير المستمر لأساليب التدخل المبتكرة بمرافقة علمية.",
  ...
  ku: {
    ...
    section3_text: "<strong>Xebata Torê û Hevkariyê:</strong> Dîlberdana çalak û hevkariya nêzîk bi hevparên sîstemê re wek dibistan, MA 11, hikumet û dadwerî.<br/><strong>Perwerde û Perwerdehiya Berdewam:</strong> Pêkanîna kursên sertîfîkayî (m. perwerdekirina perwerdekarên dijî şîdetê) ji bo misogerkirina qalîteyê di qada pêşîlêgirtinê de.<br/><strong>Xebata Giştî & Pêşxistina Konseptan:</strong> Hişyarkirina giştiya berfireh ji bo bêşîdetî û cesareta sivîl, herwiha pêşxistina berdewam a rêbazên destêwerdanê yên nûjen bi hevkarîya zanistî.",
  ...
  bks: {
    ...
    section3_text: "<strong>Rad u mreži i suradnji:</strong> Aktivna razmjena i uska suradnja sa sistemskim partnerima poput škola, MA 11, vlasti i pravosuđa.<br/><strong>Obuka i usavršavanje:</strong> Održavanje certificiranih tečajeva (npr. za obuku antinasičnih trenera) radi osiguranja kvalitete u području prevencije.<br/><strong>Rad s javnošću i razvoj koncepata:</strong> Senzibilizacija šire javnosti za nenasilje i građansku hrabrost te znanstveno praćen daljnji razvoj inovativnih metoda intervencije.",
  ...
  fa: {
    ...
    section3_text: "<strong>کار شبکه‌ای و همکاری:</strong> تبادل فعال و همکاری نزدیک با شرکای سیستمی مانند مدارس، MA 11، مقامات و قوه قضائیه.<br/><strong>آموزش و تربیت:</strong> برگزاری دوره‌های دارای گواهینامه (مثلاً برای تربیت مربیان مبارزه با خشونت) برای تضمین کیفیت در حوزه پیشگیری.<br/><strong>روابط عمومی و توسعه مفاهیم:</strong> حساس‌سازی افکار عمومی نسبت به عدم خشونت و شجاعت مدنی و همچنین توسعه مستمر روش‌های مداخله نوآورانه با همراهی علمی.",
